...
const dbName = "lab3";
const collectionName = "venkat_7132"; // Your collection name
...
async function syncMongoDBToIndexedDB() {
    ...
    try {
        ...
        // Check each document in MongoDB, add to IndexedDB if it doesn't exist
...
async function syncIndexedDBToMongoDB() {
    ...
    try {
        ...
        // Get all MongoDB records to avoid duplicates
        const mongoData = await collection.find({}).toArray();
