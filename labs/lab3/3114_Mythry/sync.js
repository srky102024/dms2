...
const dbName = "lab3";
const collectionName = "3114_Mythry"; // Use last four digits of student ID
...
function initializeIndexedDBData() {
    for (let i = 0; i < 1000; i++) {
        ...
        indexedDBData[uuid] = {
            ...
            cropType: `Crop Type ${i}`,
            weather: i % 2 === 0 ? "Sunny" : "Rainy",
            soilMoistureLevel: (Math.random() * 10).toFixed(2)
        };
    }
